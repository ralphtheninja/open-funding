...
Getting funds often relies upon having an organization, instead of having funds flow to an individual. Open source projects may need a _fiscal host_ in order to satisfy these requirements. A fiscal host goes through the hard work of setting up a company, and they host projects that then do the hard work of coding and so on, and the host takes a small fee from any funds which flow to the project.
